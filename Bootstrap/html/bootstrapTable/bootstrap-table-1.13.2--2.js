(function (global, factory) {
  ...
  (function ($) {
    ...
    var CUSTOM_FUNCTION = {
        // onJqGridPageNum:function(event,num){
        //
        // }
    };
...
/* 拷贝 end */
           ...
           /**开始生成 分页栏按钮*/
            if(this.options.paginationStyle == 'jqGrid'){
                html.push('</div>', Utils.sprintf('<div class="%s-%s pagination align-items-center">',
          ...
          /**修改 begin */
                /**拷贝 begin*/
                html.push('<span class="page-list ml-2">');
        ...
        value: function onCPageNext(event) {
          ...
          value: function onCPageNumber(event) {
              console.log("CCCCCCCCCCCCC "+$(event.currentTarget).val());
              event.preventDefault();
              if($(event.currentTarget).hasClass('glyphicon-step-backward')){// 第一页
                  ...
                  console.log("DDDDDDDDDDDDDDD "+$(event.currentTarget).val());
    ...
    BootstrapTable.CUSTOM_FUNCTION = CUSTOM_FUNCTION;
    ...
    $.fn.bootstrapTable.custom = BootstrapTable.CUSTOM_FUNCTION;;
