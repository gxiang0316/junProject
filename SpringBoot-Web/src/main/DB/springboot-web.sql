...
CREATE TABLE `gw_dict` (
  ...
  `type` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT '字典类型',
  `code` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT '字典码',
  `value` varchar(1000) COLLATE utf8mb4_bin NOT NULL COMMENT '字典值',
...
CREATE TABLE `gw_element_permission` (
  ...
  PRIMARY KEY (`ep_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='页面元素权限表';
...
CREATE TABLE `gw_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `userid` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用户id',
  `operation` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用户操作',
  `clazz` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '请求的类',
  ...
  `ex_msg` longtext COLLATE utf8mb4_bin COMMENT '异常信息',
...
INSERT INTO `gw_menu` VALUES ('1001', '用户管理', ' sysMng/userMng', '100', 'fa fa-user', '1', '管理系统用户，系统管理子项', '0', '2019-02-27 14:31:17', '2019-02-27 14:31:17');
INSERT INTO `gw_menu` VALUES ('1002', '角色管理', ' sysMng/roleMng', '100', 'fa fa-user-md', '2', '管理系统角色，系统管理子项', '0', '2019-02-27 14:31:17', '2019-02-27 14:46:45');
INSERT INTO `gw_menu` VALUES ('1003', '菜单管理', ' sysMng/menuMng', '100', 'fa fa-th-list', '3', '管理系统菜单，系统管理子项', '0', '2019-02-27 14:31:17', '2019-02-27 14:46:45');
INSERT INTO `gw_menu` VALUES ('1004', '页面元素权限管理', ' sysMng/elementPromissionMng', '100', 'fa fa-th', '4', '管理系统中页面元素权限，系统管理子项', '0', '2019-02-27 14:31:17', '2019-02-27 14:46:45');
INSERT INTO `gw_menu` VALUES ('1005', '数据字典管理', ' sysMng/dictMng', '100', 'fa fa-th-large', '5', '管理系统中数据字典，系统管理子项', '0', '2019-02-27 14:31:17', '2019-02-28 22:08:53');
INSERT INTO `gw_menu` VALUES ('1006', '系统日志管理', ' sysMng/logMng', '100', 'fa fa-list', '6', '管理系统中日志，系统管理子项', '0', '2019-02-27 14:31:17', '2019-02-27 14:46:45');
INSERT INTO `gw_menu` VALUES ('1011', 'java', ' ', '101', 'fa fa-glass', '1', 'java - 编程分类子项', '0', '2019-02-27 14:31:17', '2019-02-27 14:31:17');
INSERT INTO `gw_menu` VALUES ('1012', '前端', ' ', '101', 'fa fa-html5', '2', '前端 - 编程分类子项', '0', '2019-02-27 14:31:17', '2019-02-28 22:08:50');
INSERT INTO `gw_menu` VALUES ('1013', 'linux', ' ', '101', 'fa fa-linux', '3', 'linux - 编程分类子项', '0', '2019-02-27 14:31:17', '2019-02-27 14:31:17');
INSERT INTO `gw_menu` VALUES ('1014', '数据库', ' ', '101', 'fa fa-database', '4', '数据库 - 编程分类子项', '0', '2019-02-27 14:31:17', '2019-02-27 14:31:17');
INSERT INTO `gw_menu` VALUES ('1021', '技术博客', ' ', '102', 'fa fa-tencent-weibo', '1', '技术博客 - 随笔子项', '0', '2019-02-27 14:31:17', '2019-02-27 15:20:45');
INSERT INTO `gw_menu` VALUES ('1022', '生活随笔', ' ', '102', 'fa fa-pencil', '2', '生活随笔 - 随笔子项', '0', '2019-02-27 14:31:17', '2019-02-27 15:19:28');
...
CREATE TABLE `gw_menu_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COMMENT='菜单与角色关联表';
...
INSERT INTO `gw_menu_role` VALUES ('16', '1022', '102');
...
CREATE TABLE `gw_role_permission` (
  ...
  `role_id` int(10) NOT NULL COMMENT '角色id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='元素权限与角色表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1002 DEFAULT CHARSET=utf8mb4 COMMENT='系统参数表';
...
CREATE TABLE `gw_user` (
  ...
  `status` varchar(2) COLLATE utf8mb4_bin DEFAULT '0' COMMENT '状态  0：正常  1：已锁定  2：禁用',
