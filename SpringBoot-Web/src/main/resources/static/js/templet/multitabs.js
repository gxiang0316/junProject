...
if (typeof jQuery === "undefined") {
    ...
    defaultLayoutTemplates = {
        ...
        default: '<div class="mt-wrapper {mainClass}" style="height: 100%;" >' +
            ...
            '<li class="mt-move-left"><a style="border: none;margin-top:-5px;height:40px;"><i class="fa fa-backward" style="color: #3c8dbc;"></i></a></li>' +
            '</ul>' +
            '</div>' +
    ...
    MultiTabs.prototype = {
        ...
        _createNavTab: function (param) {
            ...
            if ($navTabLi.length) {
                ...
                $el.navPanelList.append('<li style="height: 35px;">' + navTabHtml + '</li>');
            }
    ...
    $.fn.multitabs = function (option, id) {
        ...
        if (!multitabs) {
            ...
            // opts.nav.style = (opts.nav.style === 'nav-pills') ? 'nav-pills' : 'gw-nav-tabs';
    ...
    $.fn.multitabs.defaults = {
        ...
        nav: {
            ...
            // style: 'gw-nav-tabs' //can be nav-tabs or nav-pills
        },
        content: {
            ajax: {
