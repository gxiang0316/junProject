...
/**
 * 资源文件读取工具类
 * Properties与ResourceBundle的区别：ResourceBundle常用来读取国际化文件，Properties读取普通文件
 */
...
//		System.out.println(getValue("resources.messages", "101",new Object[]{100,200}));
        ...
        /*
            springboot 中ResourceBundle 加载配置文件
                报java.util.MissingResourceException: Can't find bundle for base name sysParam.properties, locale zh_CN
            如果带有后缀properties 则从项目根路径查找，去掉后缀则默认是classpath下查找。修改成如下则正常通过。
         */
		System.out.println(getValue("sysParam","sys.param.1000"));
