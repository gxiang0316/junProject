...
if (typeof jQuery === "undefined") {
    ...
    defaultLayoutTemplates = {
        ...
        default: '<div class="mt-wrapper {mainClass}" style="height: 100%;" >' +
            ...
            '<div class="mt-nav-bar {navClass}" style="background-color: {backgroundColor};padding-top:5px;height:40px;">' +
            '<div class="mt-nav mt-nav-tools-left">' +
            '<ul  class="nav {nav-tabs}">' +
            // '<li class="mt-move-left"><a><i class="fa fa-backward"></i></a></li>' +
            '<li class="mt-move-left"><a style="border: none;margin-top:-5px;"><i class="fa fa-backward"></i></a></li>' +
            '</ul>' +
            '</div>' +
            ...
            '<li class="mt-move-right"><a style="border: none;margin-top:-5px;"><i class="fa fa-forward"></i></a></li>' +
            '<li class="mt-dropdown dropdown">' +
            '<a href="#"  style="border: none;margin-top:-5px;" class="dropdown-toggle" data-toggle="dropdown">{dropdown}<span class="caret"></span></a>' +
